...
int Parameters_Solve (matrix<double> & AMatrix,  int num_rows, int num_cols, double array_U[], double D[], double array_V[], double dummy_array[], double B[], vector<double>& X)
{
  int i, j;
  int num_cols_B {0};
  ...
  print_output(num_rows, num_cols, num_rows, num_cols, array_U, &D[0], array_V, X);
  return 0;
}
...
{	
  ...
  Parameters_Solve(AMatrix, num_rows, num_cols, array_U, &D[0], array_V, &dummy_array[0], &B[0], X);
